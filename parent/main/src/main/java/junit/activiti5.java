...
import com.study.zh.activitiListener.NoListener;
import com.study.zh.activitiListener.YesListener;
...
/*    ApplicationContext ioc = new ClassPathXmlApplicationContext("spring/spring-*.xml");
    ...
    public void test02(){
        ...
        Deployment deploy = repositoryService.createDeployment().addClasspathResource("bpmn/MyProcess8.bpmn").deploy();
...
//        System.out.println("processInstance="+processInstance);
    ...
    public void test02(){
        ...
        Deployment deploy = repositoryService.createDeployment().addClasspathResource("bpmn/register.bpmn").deploy();
