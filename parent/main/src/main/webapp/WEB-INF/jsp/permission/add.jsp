...
<%--			  <div class="form-group">
				 <label for="ficonlist">许可图标</label>

				  <select id="ficonlist" class="form-control" multiple size="10" style="width:200px;overflow-y:auto;">
					  <option><lable class="glyphicon glyphicon-check"></lable> </option>
				  </select>
				 <br>
			  </div>--%>
			  <div class="form-group">
