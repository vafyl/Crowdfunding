...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH }/bootstrap/css/fileinput.min.css">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary" style="float:right;margin-left: 10px;" onclick="window.location.href='${APP_PATH}/user/toAdd.htm'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                    <button type="button" onclick="toExcel()" class="btn btn-info" style="float:right;margin-left: 10px" ><i class="glyphicon glyphicon-minus-sign"></i> 导出</button>
                    <button type="button" id="upload" onclick="inExcel()" class="btn btn-info" style="float:right;" ><i class="glyphicon glyphicon-plus-sign"></i> 导入</button>
                    <br>
                    <hr style="clear:both;">
...
<script src="${APP_PATH}/bootstrap/js/fileinput.min.js"></script>
            ...
            success : function(result){
                ...
                if(result.success){
                    ...
                    $.each(data,function(i,n){
                        ...
                        content+='  <td>';
                        content+='	  <button type="button" onclick="window.location.href=\'${APP_PATH}/user/assignRole.htm?userid='+n.id+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
...
/*                    var contentBar = '';
    ...
    function inExcel() {
        $("#f_upload").fileinput({
            language: 'zh',//设置语言
            uploadUrl: "${APP_PATH}/user/doToExcel.do",//上传的地址
